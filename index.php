...
<html>
	<head>
		<title>Andrii Provozin - DEV</title>
		<meta charset="utf-8" />
	...
	<body class="is-preload">
		...
		<!-- Header -->
			<section id="header">
				<header class="major">
					<h1>Andrii Provozin</h1>
					<p>	<a target="_blank" href="https://github.com/Developik/">GitHub</a> -
						<a target="_blank" href="https://www.linkedin.com/in/andrii-provozin/">Linkedin</a> -
						<a target="_blank" href="https://stackoverflow.com/story/developik">Stackoverflow</a> 
					</p>
				...
				<div class="container">
					<ul class="actions special">
						<li><a href="https://drive.google.com/open?id=18hez2tQMTZLArmki5gjvFs0e1eVObKJ2" target= "_blank" class="button primary scrolly">Download Resume</a></li>
					</ul>
				</div>
			</section>
